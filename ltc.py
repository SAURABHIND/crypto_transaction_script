...
owner = 'LNGZZwZFHydWtZRjj3FJQTstY7AGGx3Nhv'
#owner = ''
...
with urllib.request.urlopen("https://api.blockcypher.com/v1/ltc/main/addrs/LNGZZwZFHydWtZRjj3FJQTstY7AGGx3Nhv") as url:
  data = json.loads(url.read().decode())
  for item in data["txrefs"]:
    txHash = item["tx_hash"]
    with urllib.request.urlopen("https://api.blockcypher.com/v1/ltc/main/txs/"+txHash) as urlInner:
  ...
  with open("/home/bsetec/Desktop/ltc.csv","w") as out_file:
