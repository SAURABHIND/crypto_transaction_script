...
owner = 'DCSmUXwDUaTj9jzQB8f9Ujx2iZ1HoVkMuE'
...
with urllib.request.urlopen("https://api.blockcypher.com/v1/doge/main/addrs/DCSmUXwDUaTj9jzQB8f9Ujx2iZ1HoVkMuE") as url:
  data = json.loads(url.read().decode())
  for item in data["txrefs"]:
    txHash = item["tx_hash"]
    with urllib.request.urlopen("https://api.blockcypher.com/v1/doge/main/txs/"+txHash) as urlInner:
